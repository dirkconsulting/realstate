...
class Wp_Kausa_Properties_Onload {
    ...
    public static function add_custom_admin_sidebar_script() {
        if (is_user_logged_in()) {
            ...
            if (in_array('agency', $current_user->roles)) {
                ...
                $inline_script .= ");";
                $inline_script .= "$.getScript('" . esc_url(WP_KAUSA_PROPERTIES_PLUGIN_URL . "public/js/agency/wp-kausa-properties-agency-sidebar.js") . "');";
                $inline_script .= "}";
                $inline_script .= "});";
    ...
    public static function display_kausa_property_meta_column($column, $post_id) {
        switch ($column) {
            case 'property_status':
                $sold = get_post_meta($post_id, '_kausa_property_sold', true);
                $reserved = get_post_meta($post_id, '_kausa_property_reserved', true);
                $available = get_post_meta($post_id, '_kausa_property_available_to_reserve', true);
                if ($sold === 'yes') {
                    echo 'Sold';
                } elseif ($reserved === 'yes') {
                    echo 'Reserved';
                } elseif ($available === 'yes') {
                    echo 'Available';
                } else{
                    echo 'Available';
                }
    ...
    /**
     * Hook to add content of status change meta boxes to property post type
     */
            ...
            <div class="status-update-main-box">
                <div class="status-update-top-box">
                    <div class="status-update-field-box">
                        ...
                        <input type="date" id="kausa_property_date_input" placeholder="Select Date">
                    </div>
                    <div class="status-update-field-box">
                        ...
                        <input type="time" id="kausa_property_time_input" placeholder="Select Time">
                        <input type="hidden" name="kausa_property_date" id="kausa_property_date">
                    </div>
                    <div class="status-update-field-box">
                        ...
                        <select id="kausa_property_status" name="kausa_property_status">
                            ...
                            <option value="sold"><?php echo isset($additional_features_translation['kausa-property-sold']) ? $additional_features_translation['kausa-property-sold'] :  'Sold'; ?></option>
                            <?php if($reserved_by_user && $avaliable_for_reserve == 'no'){ ?>
                                <option value="unreserve"><?php echo isset($additional_features_translation['kausa-property-unreserve']) ? $additional_features_translation['kausa-property-unreserve'] :  'Unreserve'; ?></option>
                            <?php } ?>
                            <?php if(!$reserved_by_user){ ?>
                                <option value="reserve"><?php echo isset($additional_features_translation['kausa-property-reserve']) ? $additional_features_translation['kausa-property-reserve'] :  'Reserve'; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="status-update-field-box">
                        ...
                        <select id="kausa_property_user" name="kausa_property_user">
                            <?php  if($avaliable_for_reserve == 'yes' || $avaliable_for_reserve == ''){?>
                            ...
                            <?php }else{ ?>
                                ...
                                <?php foreach ($users as $user): ?>
                                    <?php if($reserved_by_user){ ?>
                                        <?php if($reserved_by_user == $user->ID){ ?>
                                            <option value="<?php echo $user->ID; ?>"><?php echo $user->user_login; ?></option>
                                        <?php } ?>
                                    <?php } ?>
                                <?php endforeach; ?>
    ...
    public static function kausa_properties_add_gallery_metabox() {
        add_meta_box(
            ...
            __('Property Gallery', 'textdomain'),
    ...
    public static function kausa_property_meta_box_content($post) {
        $fields = [
            ...
            'kausa_property_commission' => get_post_meta($post->ID, 'kausa_property_commission', true), // Añadido el campo de comisión
        ];
        $address_fields = [
    ...
    /**
     * Save property details meta keys data
     */
    public static function save_kausa_property_meta_box_data($post_id) {
        ...
        $fields = [
            ...
            'kausa_property_commission', // Añadido el campo de comisión
        ];
    
        foreach ($fields as $field) {
            if (isset($_POST[$field])) {
                // Handle arrays (e.g., repeaters, checkbox groups)
                ...
                // If the field is not set, delete it
    ...
    public static function kausa_properties_grid_shortcode($atts) {
        ...
        $kausa_args = [
            ...
            'paged'          => 1,
            'meta_query'     => [
                'relation' => 'OR', // Include posts based on multiple conditions
                [
                    'key'     => '_kausa_property_sold',
                    'value'   => 'yes',
                    'compare' => '!=', // Exclude posts where value is 'yes'
                ],
                [
                    'key'     => '_kausa_property_sold',
...
<p class="kausa-property-price"><?php echo esc_html( $precio_formateado ); ?>€</p>
            ...
            /* if ($kausa_properties->max_num_pages > 1) {
                echo '<div class="kausa-properties-pagination">';
                echo paginate_links([
                    'total' => $kausa_properties->max_num_pages,
                    'current' => $paged,
                    'type' => 'list',
                    ]);
                echo '</div>';
    ...
    public static function kausa_properties_manage_reserved_properties(){
                    ...
                    <form action="" method="POST" class="form-table">
                        <table>                       
                            ...
                            <tr>
                                ...
                                <td><select id="kausa-penalty-free-reservation-type">
                            ...
                            <tr>
                                ...
                                <td><select id="kausa-penalty-reservation-type">
        ...
        public static function register_kausa_properties_string_translation(){
            ...
            $property_details_property_area = "";
            $property_details_property_condition = "";       
            ...
            $property_details_commission = ""; // Añadido para la traducción de comisión
            ...
            if(is_array($property_details_translation)){
                ...
                $property_details_commission = isset($property_details_translation["kausa-property-commission"]) ? $property_details_translation["kausa-property-commission"] : ""; // Añadido para la traducción de comisión
            }
                ...
                <form id="kausa-property-translation-submit" action="" method="post" class="form-table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="kausa-property-property-type" name="kausa-property-property-type" class="form-control" placeholder="Property Type" value="<?php echo $property_details_property_area ? $property_details_property_area : ""; ?>" /></td>
                        </tr>    
                        <tr>
                        ...
                        <tr>
                            ...
                            <th><label for="kausa-property-property-status">Property Status</label></th>
                            <td><input type="text" id="kausa-property-property-status" name="kausa-property-property-status" class="form-control" placeholder="Property Status" value="<?php echo $property_details_property_status ? $property_details_property_status : ""; ?>" /></td>
                        </tr>  
                        <tr>
